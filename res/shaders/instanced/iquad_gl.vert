...
void main()
{
    vec2 instance_scale = getInstanceScale(gl_InstanceID);
    vec3 instance_pos = getInstancePosition(gl_InstanceID);
    ...
    v_uvs = a_uvs;
    v_instance_texture_id = data[gl_InstanceID].textureLayer;
}
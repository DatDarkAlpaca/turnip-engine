...
namespace tur::vulkan
{
	...
	inline constexpr vk::PrimitiveTopology GetPrimitiveTopology(PrimitiveTopology topology)
	{
		switch (topology)
		{
	...
	*/
	...
	inline constexpr vk::Format GetTextureFormat(TextureFormat format)
	{
	...
	/*
	inline constexpr vk::Format GetFormat(TextureFormat format)
	{
		switch (format)
		{
